...
<html>
    ...
    <body>
        ...
        <c:if test="${not empty requestScope.SELFDELETEERROR}">
            <font color="red">${requestScope.SELFDELETEERROR}</font>
            
        </c:if> <br/>
        <c:if test="${not empty requestScope.ADMINDELETEERROR}">
            <font color="red">${requestScope.ADMINDELETEERROR}</font>
